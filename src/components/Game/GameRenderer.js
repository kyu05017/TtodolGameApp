...
const GameRenderer = ({ 
  ...
  // 게임 엔진 초기화
  useEffect(() => {
    console.log('🎮 GameRenderer 초기화 시작...');
  ...
  const panResponder = PanResponder.create({
    ...
    onPanResponderGrant: (evt) => {
      console.log('👆 터치 시작:', evt.nativeEvent.locationX);
    ...
    onPanResponderRelease: (evt) => {
      console.log('👆 터치 종료:', evt.nativeEvent.locationX);
