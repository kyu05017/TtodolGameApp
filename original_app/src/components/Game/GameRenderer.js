  ...
  const renderDropLine = useCallback(() => {
    ...
    return (
      <React.Fragment>
        ...
        <Defs>
          <View id="dropLineGradient" x1="0%" y1="0%" x2="100%" y2="0%">
            <Stop offset="0%" stopColor="#a855f7" stopOpacity="0.2" />
            <Stop offset="50%" stopColor="#8b5cf6" stopOpacity="0.9" />
            <Stop offset="100%" stopColor="#a855f7" stopOpacity="0.2" />
          </View>
          
          <View id="dropPathGradient" x1="0%" y1="0%" x2="0%" y2="100%">
  ...
  const renderBoundaries = useCallback(() => {
    ...
    return (
      <React.Fragment>
        {/* 벽 그라데이션 정의 */}
        <Defs>
          <View id="wallGrad" x1="0%" y1="0%" x2="100%" y2="0%">
            <Stop offset="0%" stopColor="#a855f7" />
            <Stop offset="50%" stopColor="#8b5cf6" />
            <Stop offset="100%" stopColor="#7c3aed" />
          </View>
          <View id="floorGrad" x1="0%" y1="0%" x2="0%" y2="100%">
        ...
        {/* 게임 오버 라인 - 예쁘게 개선 */}
        <Defs>
          <View id="dangerGrad" x1="0%" y1="0%" x2="100%" y2="0%">
